...
#define checkError(val,string) if(val) {printf(string); exit(-1);} // simpler Error Handler, der Exceptions wirf wenn etwas nicht funktioniert hat

int main(int argc, char** argv)
{
	//initilisierung von mpi
